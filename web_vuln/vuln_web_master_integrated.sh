...
# =================================================================
# VULNERABLE WEB MASTER - INTEGRATED SOLUTION (RINGKAS)
# =================================================================
# Script terintegrasi yang menggunakan file yang sudah ada
# =================================================================
...
echo -e "   sudo bash vuln_web_master_integrated.sh"
echo -e ""
...
echo -e "      - VULNERABILITY: Arbitrary File Upload via Contact Form 7"
echo -e ""
...
echo -e "   A. File Upload Vulnerability (Government Site):"
...
echo -e ""
echo -e "   B. Contact Form 7 Vulnerability (WordPress):"
echo -e "      - Upload file via Contact Form 7"
echo -e "      - File akan disimpan di wp-content/uploads/"
echo -e "      - File dapat dieksekusi langsung"
echo -e "      - Test dengan shell.php, backdoor.php"
echo -e ""
echo -e "   C. Directory Traversal:"
echo -e "      - Akses: http://localhost:8080/uploads/"
echo -e "      - Akses: http://localhost:8000/wp-content/uploads/"
echo -e ""
echo -e "   D. Authentication Bypass:"
echo -e "      - Coba login dengan kredensial default"
echo -e "      - Test SQL injection pada form login"
echo -e ""
echo -e "   E. Information Disclosure:"
